# Generated by Django 3.2.7 on 2022-01-26 14:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(default='Samastipur', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='848114', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Main Bazar', max_length=150, verbose_name='Street Address')),
                ('property_number', models.IntegerField(default=17, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Property Number')),
