    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+918002459133', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('city', models.CharField(default='Dalsinghsarai', max_length=180, verbose_name='City')),
                ('is_buyer', models.BooleanField(default=False, help_text='Are you lookign to buy a property?', verbose_name='Buyer')),
